...
//func (i Label) TappedSecondary(event *fyne.PointEvent) {
//	//print("right click")
//	menu := NewPopUpMenu(fyne.NewMenu("",
//		fyne.NewMenuItem("Generate command of this POC",func(){
//			println("Generate")
//		}),
//		fyne.NewMenuItem("Open this POC in Exploer",func(){
//			println("Open")
//		}),
